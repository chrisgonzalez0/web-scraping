    ...
    for i in range(len(parsed_table)):
        ...
        if onetable['id'] in ['conferences','all_awards']:
            ...
            if onetable['id']=='conferences':                
                ...
                ### conferences href
                dat1 = onetable.find_all('td', attrs={'data-stat': 'conf_name'})
                dat2 = onetable.find_all('th', attrs={'data-stat': 'conf_name'}) 
                ...
                ### conference champ href
                dat1 = onetable.find_all('td', attrs={'data-stat': 'conf_champ'})
                dat2 = onetable.find_all('th', attrs={'data-stat': 'conf_champ'}) 
                if len(dat1)>len(dat2):
                    dat=dat1
                else:
                    dat=dat2        
            ...
            if onetable['id']=='all_awards':    
                ...
                ### award_name href ###
                dat1 = onetable.find_all('td', attrs={'data-stat': 'award_name'})
                dat2 = onetable.find_all('th', attrs={'data-stat': 'award_name'}) 
                if len(dat1)>len(dat2):
                    dat=dat1
                else:
                    dat=dat2        
                ...
                ### player href ###
                dat1 = onetable.find_all('td', attrs={'data-stat': 'name_full'})
                dat2 = onetable.find_all('th', attrs={'data-stat': 'name_full'}) 
                if len(dat1)>len(dat2):
                    dat=dat1
                else:
                    dat=dat2        
                ...
                ### school href ###
                dat1 = onetable.find_all('td', attrs={'data-stat': 'school_name'})
                dat2 = onetable.find_all('th', attrs={'data-stat': 'school_name'}) 
                if len(dat1)>len(dat2):
                    dat=dat1
                else:
                    dat=dat2        
